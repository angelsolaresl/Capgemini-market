...
public class AuthController {
    ...
    @Autowired
    private AuthenticationManager authenticationManager;//autenticar los datos que llegan de ussuario y contraseña validos de la conf que se tiene
    @Autowired
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
       try {
           ...
           String jwk = jwtUtil.generateToken(userDetails);
           return new ResponseEntity<>(new AuthenticationResponse(jwk),HttpStatus.OK);
